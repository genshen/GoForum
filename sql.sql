...
-- ----------------------------
BEGIN;
INSERT INTO `comment` VALUES ('80', '26', '34', '0', 'wwwww', '0', '2016-08-07 01:06:24', '2016-08-07 01:06:24', null), ('81', '26', '34', '0', 'wwwwwwwwwwwwwwwwwwwwwwwwwwwww', '0', '2016-08-07 01:07:41', '2016-08-07 01:07:41', null), ('89', '26', '34', '0', '@Hee#213 ddd?', '0', '2016-08-07 01:13:30', '2016-08-07 01:13:30', null), ('90', '26', '34', '0', '@Hee#213 ', '0', '2016-08-07 01:13:40', '2016-08-07 01:13:40', null), ('91', '26', '34', '0', '@Hee#213 ', '0', '2016-08-07 01:13:51', '2016-08-07 01:13:51', null), ('92', '26', '34', '0', '@Hee#213 fffff', '0', '2016-08-07 01:15:12', '2016-08-07 01:15:12', null), ('93', '26', '34', '0', '@Hee#213 why?', '0', '2016-08-07 01:16:02', '2016-08-07 01:16:02', null), ('99', '26', '34', '0', '@Hee#213 ', '0', '2016-08-07 01:25:34', '2016-08-07 01:25:34', null), ('100', '26', '34', '0', '@Hee#213 really?', '0', '2016-08-07 01:26:17', '2016-08-07 01:26:17', null), ('101', '26', '34', '0', '@Hee#213  big moutain!', '0', '2016-08-07 01:27:38', '2016-08-07 01:27:38', null), ('102', '26', '34', '0', '哈？', '0', '2016-08-07 01:30:15', '2016-08-07 01:30:15', null), ('103', '27', '34', '0', 'I\'m the first one~', '0', '2016-08-07 01:31:08', '2016-08-07 01:31:08', null), ('104', '27', '34', '0', '@Hee#213 k', '0', '2016-08-07 01:31:55', '2016-08-07 01:31:55', null), ('105', '27', '34', '0', '@Hee#213 ', '0', '2016-08-07 03:07:22', '2016-08-07 03:07:22', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `post_message` VALUES ('2', '34', '34', 'gensh', '0', '27', 'e', 'I\'m the first one~', '请输入内容...e哈哈哈哈', '0', '2016-08-07 01:31:08', '2016-08-07 01:31:08', null), ('3', '34', '34', 'gensh', '0', '27', 'e', '@Hee#213 k', '请输入内容...e哈哈哈哈', '0', '2016-08-07 01:31:55', '2016-08-07 01:31:55', null), ('4', '34', '34', 'gensh', '0', '27', 'e', '@Hee#213 ', '请输入内容...e哈哈哈哈', '0', '2016-08-07 03:07:22', '2016-08-07 03:07:22', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `posts` VALUES ('26', '33', '1', '222', '请输222入内容...', '<p>请输222入内容...</p><p><br></p>', '1', '0', '11', '0', '2016-08-07 00:17:41', '1', '2016-08-07 00:17:41', '2016-08-07 00:17:41', null), ('27', '34', '1', 'e', '请输入内容...e哈哈哈哈', '<p>请输入内容...</p><p>e哈哈哈哈</p>', '1', '0', '3', '0', '2016-08-07 00:19:55', '1', '2016-08-07 00:19:55', '2016-08-07 00:19:55', null), ('28', '34', '1', 'e', '请输入内容...e哈哈哈哈', '<p>请输入内容...</p><p>e哈哈哈哈</p>', '1', '0', '0', '0', '2016-08-07 00:21:34', '1', '2016-08-07 00:21:34', '2016-08-07 00:21:34', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `profile` VALUES ('33', '33', '111111', '/static/img/default.png', '0', '这家伙很懒,什么都没有', '0', '0', '0', '0'), ('34', '34', 'gensh', '/static/img/default.png', '0', '这家伙很懒,什么都没有', '0', '14', '0', '0');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `topic` VALUES ('1', '聊天', 'chat', 'chat', '#f44336', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', null), ('2', '讨论', 'slug', 'discus', '#673ab7', '1', '0000-00-00 00:00:00', '0000-00-00 00:00:00', null);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES ('33', '', '111111', 'm18813128117@163.com', '3d4f2bf07dc1be38b20cd6e46949a1071f9d0e3d', '', '', '2', '2016-08-06 23:24:11', '2016-08-06 23:24:11', null), ('34', '', 'gensh', 'genshenchu@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', '', '', '2', '2016-08-07 00:18:38', '2016-08-07 00:18:38', null);
COMMIT;

-- ----------------------------
-- Auto increment value for comment
-- ----------------------------
ALTER TABLE `comment` AUTO_INCREMENT=106;
...
-- ----------------------------
ALTER TABLE `notification` AUTO_INCREMENT=14;

-- ----------------------------
-- Auto increment value for post_message
-- ----------------------------
ALTER TABLE `post_message` AUTO_INCREMENT=5;

-- ----------------------------
-- Auto increment value for posts
-- ----------------------------
ALTER TABLE `posts` AUTO_INCREMENT=29;
